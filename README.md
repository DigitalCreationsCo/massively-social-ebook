...
3. Passes enriched context to `generateBlockInstructions()` prompt template
...
| `server/game-loop.test.ts` | 15 | Phase transitions, votes, fallbacks, dual timers |
| `server/index.test.ts` | 1 | Server module loading |
| `client/…/DecisionPhase.test.tsx` | 7 | Voting UI, timer rendering, progress bar |
